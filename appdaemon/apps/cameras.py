...
class Cameras(hass.Hass):
    ...
    def initialize(self):
        ...
        self.cat_camera_smart_plug = self.args["cat_camera_smart_plug"]
    ...
    def turn_off_on_cameras(self, entity, attribute, old, new, kwargs):
        cameras_on = self.utils.is_entity_on(self.cat_camera_smart_plug)
        ...
        if ((owen_home or allison_home) and cameras_on):
            ...
            self.turn_off(self.cat_camera_smart_plug)
            ...
            self.turn_on(self.cat_camera_smart_plug)
