...
class FrontPorch(hass.Hass):
    ...
    def initialize(self):
        ...
        self.listen_state(self.turn_on_front_porch_location_based, self.proximity_owen, new = "3") # When 3 miles from home.
        self.listen_state(self.turn_on_front_porch_location_based, self.proximity_allison, new = "3") # When 3 miles from home.
